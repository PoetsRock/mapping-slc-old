...
"use strict";angular.module("core").directive("signInDirective",function(){return{restrict:"EA",templateUrl:"/modules/core/client/directives/views/sign-in-directive.html",controller:["$scope","$http","Authentication",function($scope,$http,Authentication){var userProfileImage="";return $scope.user=Authentication.user,""===$scope.user?void console.log("directive profilePic Service - calling nothing, just `return`"):void("default.png"===Authentication.user.profileImageFileName||""===Authentication.user.profileImageFileName?$scope.user.profileImage="modules/users/client/img/profile/default.png":""!==Authentication.user.profileImageFileName?$scope.user.profileImage="modules/users/client/img/profile/uploads/uploaded-profile-image.jpg":($scope.getUploadedProfilePic=function(){var user=Authentication.user,configObj={cache:!0};$http.get("api/v1/users/"+user._id+"/media/"+user.profileImageFileName,configObj).then(function successCallback(successCallback){return console.log("profilePic - successCallback\n",successCallback),console.log("successCallback.data.imageAsBase64Array\n",successCallback.data.imageAsBase64Array),console.log("successCallback.data.imageAsUtf8\n",successCallback.data.imageAsUtf8),console.log("successCallback.data.imageObjectAsString\n",successCallback.data.imageObjectAsString),userProfileImage=successCallback.data.imageAsBase64Array},function errorCallback(errorCallback){return console.log("profile photo error",errorCallback),userProfileImage="modules/users/client/img/profile/default.png"})},$scope.getUploadedProfilePic(),$scope.user.profileImage=userProfileImage))}]}});
