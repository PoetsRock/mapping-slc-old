...
"use strict";angular.module("users").factory("Users",["$resource",function($resource){return $resource("/api/v1/users",{},{update:{method:"PUT"}})}]),angular.module("users").factory("Admin",["$resource","AdminAuthService",function($resource,AdminAuthService){return"admin"===AdminAuthService.user?$resource("/api/v1/users/:userId"):void 0}]),angular.module("users").factory("AdminUpdateUser",["$resource","AdminAuthService",function($resource,AdminAuthService){return"admin"===AdminAuthService.user?$resource("api/v1/users/:userId",{userId:"@_id"},{update:{method:"PUT"}},{create:{method:"POST"}},{read:{method:"GET"}}):void 0}]);
