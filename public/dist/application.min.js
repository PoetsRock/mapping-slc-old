...
"use strict";angular.module("core").directive("modalDirective",function(){return{restrict:"E",link:function(){$uibModal.open({animation:!0,templateUrl:"/modules/projects/client/directives/views/project-warning-modal.html",controller:function($scope,$modalInstance,$location){$scope.stay=function(result){console.log("stay just a little bit longer, oh won't you stay"),$modalInstance.close(function(result){console.log("result: ",result)})},$scope.leave=function(){$scope.stay(),$location.path(toState)}},size:"lg"})}}});
