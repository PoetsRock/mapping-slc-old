...
"use strict";angular.module("core").directive("randomMapDirective",[function($scope){var maps={originalMap:"poetsrock.55znsh8b",grayMap:"poetsrock.b06189bb",mainMap:"poetsrock.la999il2",topoMap:"poetsrock.la97f747",greenMap:"poetsrock.jdgpalp2",funkyMap:"poetsrock.23d30eb5"};[maps.originalMap,maps.grayMap,maps.mainMap,maps.topoMap,maps.greenMap,maps.funkyMap];return{template:"<div></div>",restrict:"EA",link:function(scope,element,attrs){}}}]);
...
"use strict";angular.module("core").directive("modalDirective",function(){return{restrict:"E",link:function(){$uibModal.open({animation:!0,templateUrl:template,controller:["$scope","$modalInstance","$location",function($scope,$modalInstance,$location){$scope.stay=function(result){console.log("stay just a little bit longer, oh won't you stay"),$modalInstance.close(function(result){console.log("result: ",result)})},$scope.leave=function(){$scope.stay(),$location.path(toState)}}],size:"lg"})}}});
